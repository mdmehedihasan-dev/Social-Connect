      ...
      <div className="relative pt-5">
        <div className=" rounded-md h-[660px] msgbox-container w-small lg:w-[700px]">
          <div>
              ...
              msgList.map((item, i) =>
                ...
                item.whoreceiveid == active.activeuserid ? (
                  <div key={i} className="text-right">
                    <div className="inline-block px-2 py-1 mb-20 bg-blue-500 border-2 rounded-xl">
                  ...
                  item.whosendid == active.activeuserid && (
                    <div key={i} className="text-left">
                      <div className="inline-block px-2 py-1 bg-green-500 border-2 rounded-xl">
            ...
            <div className="absolute rounded-bl-md rounded-br-md  bottom-0  lg:w-[700px] border-t p-3 bg-green-500">
