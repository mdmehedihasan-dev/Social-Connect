...
const BlockUser = () => {
  ...
  return (
    <div className="pt-5">
      ...
      >
        <ImBlocked />
        <div className="absolute hidden w-10 h-10 text-lg font-bold text-center transition-opacity duration-300 bg-red-600 rounded-full opacity-0 md:block md:w-16 md:h-16 group-hover:opacity-100">
         Block Users </div>
      </div>
      {show && (
        <div className="absolute dark:bg-black bg-white top-24 left-7 sm:left-[250px] h-auto p-2 rounded-md max-h-80 box-container w-small lg:w-box">
          {/* friends header  */}
