...
const FriendRequest = () => {
  ...
  return (
    <div className="pt-5">
      <div
        ref={dropdownRef}
        className="relative flex items-center justify-center w-10 h-10 text-xl text-white bg-purple-600 rounded-full cursor-pointer group md:w-16 md:h-16 md:text-4xl"
      >
        <FaUserFriends />
        <div className="absolute hidden w-10 h-10 text-base font-bold text-center transition-opacity duration-300 bg-purple-600 rounded-full opacity-0 md:block md:w-16 md:h-16 group-hover:opacity-100">
         Friend Request </div>
      </div>
      {show && (
